...
public class Configuration {
    ...
    /**
     * 允许在嵌套语句中使用行分界RowBounds
     */
    protected boolean safeRowBoundsEnabled = false;
    /**
     * 允许在嵌套语句中使用ResultHandler,如果允许，设置false。
     */
    ...
    /**
     * 为驱动程序设置一个提示，以控制取回结果的获取大小。该参数值可以通过查询设置覆盖。
     */
    ...
    /**
     * 指定 MyBatis 是否以及如何自动映射指定的列到字段或属性。NONE 表示取消自动映射；
     * PARTIAL 只会自动映射没有定义嵌套结果集映射的结果集。FULL 会自动映射任意复杂的结果集（包括嵌套和其他情况）。
     */
